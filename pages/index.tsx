...
const Categoria = () =>{
  return (<div className='bg-gray-100 w-64 m-1'>categoriaComponent</div>)
}
 ...
 function allcards(){
  ...
  return (
    <div className={styles.container}>
      ...
      <nav className="bg-indigo-50 flex justify-between">
      ...
      <div className="bg-red-500 flex flex-col h-24 mt-4 justify-center">
